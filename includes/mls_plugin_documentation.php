...
function mls_plugin_add_shortcodes_submenu() {
    add_submenu_page(
        ...
        'MLS Plugin Shortcodes', // Page title
        'Shortcodes',          // Menu title
        'manage_options',         // Capability required
        'mls_plugin_shortcodes', // Menu slug for the submenu
        'mls_plugin_shortcodes_page' // Function to display the page content
    );
}

add_action('admin_menu', 'mls_plugin_add_shortcodes_submenu');
